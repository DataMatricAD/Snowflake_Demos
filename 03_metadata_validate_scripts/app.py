#  This script is part of a Streamlit application that allows users to inspect Snowflake metadata.
#  It includes a chat interface for asking questions about Snowflake metadata and displays the results.
